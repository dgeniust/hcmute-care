...
public interface ScheduleRepository extends JpaRepository<Schedule, Long> {
    ...
    Page<Schedule> findAllByDoctorIdAndDateBetween(Long doctorId, Integer roomId, LocalDate startDate, LocalDate endDate, Pageable pageable);
    ...
    boolean existsByDoctorIdAndDateAndIdNot(Long doctorId, LocalDate date, Long id);
}
