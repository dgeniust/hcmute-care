...
const NoRecord_Booking = ({ setStatus }) => {
  ...
  return (
    <div className="w-full h-full space-y-4">
      <div
        className="flex flex-row gap-4 w-full h-full items-center"
        onClick={() => handleSetStatus("records")}
      >
        <Button
          ...
          <form action="" className="flex flex-col">
            <div className="grid grid-flow-row grid-cols-2 gap-4 text-black">
                ...
                >
                  ...
                  <span className="ml-1">
                    <img
                      width="10"
                      height="10"
                      src="https://img.icons8.com/forma-bold-filled-sharp/24/FA5252/asterisk.png"
                      alt="asterisk"
                    />
                  </span>
                  <span className="text-xs italic">
                    (theo CCCD/CMND/Passpot)
                  </span>
                </label>
                <Input
              ...
              <div className="flex flex-row space-x-2 w-full">
                <div className="w-full">
                  ...
                  <Select
                    ...
                    onChange={(value, option) =>
                      handleSelectChange(value, "gender", option)
                    }
                    options={[
                      {
                        value: "male",
                ...
                <div className="w-full">
                  ...
                  <Select
                    ...
                    onChange={(value, option) =>
                      handleSelectChange(value, "nation", option)
                    }
                    options={countries}
                  />
                </div>
              ...
              <div className="flex flex-row space-x-2">
                <div className="w-full">
                  ...
                  <Select
                    ...
                    onChange={(value, option) =>
                      handleSelectChange(value, "career", option)
                    }
                    options={[
                      {
                        value: "vietnam",
              ...
              <div>
                ...
                <Input
                  placeholder="Nhập chính xác địa chỉ..."
