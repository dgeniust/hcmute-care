        ...
        const handleShowMedicalRecord = async () => {
            try {
                ...
                if(!response.ok) {
                    ...
                    handleHttpStatusCode(response.status, '',`Lấy thông tin hồ sơ thất bại: ${errorText || response.statusText}`);
                    return;
                }
                    ...
                    <div className='grid grid-flow-row grid-cols-3 gap-2 w-1/3'>
                        ...
                        {/* Existing profiles */}
                        {
                                ...
                                medicalRecords.map((record) => (
                                    ...
                                    >
                                        <img
                                            width="48"
                                            height="48"
                                            src={record.patient.gender === 'MALE' ? 'https://api.dicebear.com/7.x/miniavs/svg?seed=8' : 'https://api.dicebear.com/9.x/miniavs/svg?seed=Liliana'}
                                            alt="businessman"
                                        />
                                        <span>
                            ...
                            <div className='flex w-full h-full justify-center items-center'>
                                <h1 className='text-black font-bold text-base'>Chưa có hồ sơ bệnh án</h1>
                            </div>
                        }
                    </div>
