  ...
  useEffect(() => {
    const fetchRevenue = async () => {
      try {
        ...
        const response = await fetch(`${apiUrl}v1/revenue/customers`, {
          method: "GET",
          headers: {
        ...
        const successMessage = `Tổng số tài khoản: ${
          statsData.totalAccounts || 0
        }, Tổng số hồ sơ bệnh án: ${statsData.totalMedicalRecords || 0}`;
        handleHttpStatusCode(
          response.status,
          successMessage,
          "Thống kê người dùng",
