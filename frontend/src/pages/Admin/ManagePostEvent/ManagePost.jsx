        ...
        try {
            ...
            if(!response.ok) {
                ...
                handleHttpStatusCode(response.status,'',
                    `Đăng bài viết thất bại : ${errorText || response.statusText}`, messageApi); // Handle the error response
                return;
            }
            else {
            ...
            notifyErrorWithCustomMessage("Dữ liệu bài viết không hợp lệ hoặc thiếu thông tin", messageApi);
            return null;
        }
    }
    return (
    ...
    style={{
        backgroundImage: `url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32' width='32' height='32' fill='none' stroke-width='2' stroke='%23d4d4d4'%3e%3cpath d='M0 .5H31.5V32'/%3e%3c/svg%3e")`,
                ...
                <div className=' border rounded-xl min-h-[380px] h-full w-full p-2 flex justify-center'>
                    <EmojiPickerInput setTextData={setTextData} setHeaderData={setHeaderData} setStorageImg={setStorageImg} storageImg={storageImg} handleUploadPost={handleUploadPost}/>
                </div>
                ...
                <div className=' border rounded-xl min-h-[380px] p-2 h-full'>
                    ...
                    <TwitterPost content={textData} postImages={storageImg} header={headerData}/>
                </div>
            </div>
            {contextHolder}
        </div>
