    ...
    try {
      ...
      if (response.ok && result.status === 200) {
        ...
        notifySuccess(
          ...
          "Chào mừng bạn đến với HCMUTE CARE",
          notificationApi,
      ...
      <div className="flex flex-col justify-center items-center h-[70vh] w-[60vh] border bg-white border-gray-300 rounded-xl shadow-lg">
        ...
        >
          <div className="w-full h-fit pb-3 px-6 flex-col flex text-black">
            <label
              htmlFor="phone"
              className="justify-start text-left mb-1 font-normal"
            >
              Số điện thoại
            </label>
            <Input
          ...
          <div className="w-full py-6 px-6">
            {isFormEmpty ? (
              <Button disabled size="large" block htmlType="submit">
                Đăng nhập
              </Button>
            ) : (
              <Button
        ...
        <div>
          <Link className="text-sky-600" to={"/getPhone"}>
