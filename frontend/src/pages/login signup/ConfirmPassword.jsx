...
const ConfirmPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${apiUrl}v1/auth/register/set-password`, {
        method: "POST",
        headers: {
      ...
      if (response.ok) {
        ...
        if (data.status === 201) {
          ...
          notifyErrorWithCustomMessage(
            data.message || "Mật khẩu không bảo mật 🫠",
            messageApi
          );
        }
      }
  ...
  const isButtonDisabled =
    !isValidPassword || !isValidUppercase || !isValidNumber || !isPasswordMatch;
  return (
    <div className="flex justify-center items-center h-screen w-screen login-bg bg-cover bg-center">
      <div className="flex flex-col justify-center items-center h-[100vh] w-[60vh] border border-black bg-white">
        <div className="w-full flex flex-row justify-between px-3 text-black font-bold text-xl">
          <Button
            color="default"
            variant="link"
            icon={<ArrowLeftOutlined style={{ color: "#3498db" }} />}
        ...
        <div className="w-full flex flex-row pt-3 items-center px-6">
          <img
            src="/img/logo_hcmute_care.png"
            alt=""
            width={"150px"}
            height={"150px"}
          />
          <div className="text-black text-xl font-bold flex-col text-left">
            <p>Chào mừng đến với</p>{" "}
            <span className="text-sky-700 text-left">HCMUTE CARE</span>
          </div>
        </div>
        ...
        >
          <div className="w-full h-fit pb-3 px-6 flex-col flex text-black">
            <label
              htmlFor="phone"
              className="justify-start text-left mb-1 font-bold"
            >
              Nhập mật khẩu
            </label>
            <Input.Password
              ...
              items={[
                {
                  dot: isValidPassword ? (
                    <CheckCircleOutlined
                      style={{ color: "#2ed573", fontSize: "20px" }}
                    />
                  ) : (
                  ...
                  children: (
                    <span
                      style={{
                        color: isValidPassword ? "#2ed573" : "gray",
                        fontWeight: isValidPassword ? "bold" : "normal",
                      }}
                    >
                ...
                },
                {
                  ...
                  children: (
                    <span
                      style={{
                        color: isValidUppercase ? "#2ed573" : "gray",
                        fontWeight: isValidUppercase ? "bold" : "normal",
                      }}
                    >
                ...
                },
                {
                  ...
                  children: (
                    <span
                      style={{
                        color: isValidNumber ? "#2ed573" : "gray",
                        fontWeight: isValidNumber ? "bold" : "normal",
                      }}
                    >
                ...
                },
                {
                  ...
                  children: (
                    <span
                      style={{
                        color: isPasswordMatch ? "#2ed573" : "gray",
                        fontWeight: isPasswordMatch ? "bold" : "normal",
                      }}
                    >
          ...
          <div className="w-full py-6 px-6">
            {isButtonDisabled ? (
              <Button
                disabled
                style={{ backgroundColor: "#bdc3c7", color: "white" }}
                size="large"
                block
              >
                Xác nhận
