...
import { LockOutlined, CheckCircleFilled, CheckCircleOutlined  } from '@ant-design/icons';
import { Input, Button, notification, message, Timeline } from 'antd';
...
const Login = () => {
  ...
  useEffect(() => {
    console.log(isValidPassword, isValidUppercase, isValidNumber, isPasswordMatch);
  ...
  return <div className="flex justify-center items-center h-screen w-screen login-bg bg-cover bg-center">
    <div className="flex flex-col justify-center items-center h-[90vh] w-[60vh] border border-black bg-white">
    ...
    <div className="px-6 pb-6 w-full text-left">
        <p className="text-gray-500">Đặt mật khẩu mới</p>
    </div>
    <form className="flex flex-col justify-center items-center w-full h-fit" onSubmit={handleSubmit}>
      ...
      <div className="w-full h-fit pb-3 px-6 flex-col flex text-black">
        <label htmlFor="password" className="justify-start text-left mb-1 font-bold">Nhập lại mật khẩu</label>
        <Input.Password 
